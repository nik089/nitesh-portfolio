...
export default function Footer() {
  return (
    <footer className="relative border-t border-[var(--border)] bg-[var(--surface)] px-6 py-16">
        ...
        >
          <div>
            <div className="flex items-center gap-3 mb-5">
              <div className="flex h-10 items-center justify-center rounded-xl border border-[var(--border)] bg-[var(--glass-panel)] px-3.5 font-mono text-sm font-bold backdrop-blur-md shadow-[0_0_15px_rgba(0,212,255,0.05)]">
